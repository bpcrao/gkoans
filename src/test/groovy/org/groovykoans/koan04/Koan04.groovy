...
class Koan04 extends GroovyTestCase {
    ...
    void test01_IntroToClosures() {
        ...
        def resultClosure={a,b->   
			assert a.asType(Integer.class)&&b.asType(Integer.class)
			print a.asType(Integer.class)
			print b.asType(Integer.class)
			(a+b).multiply(2)
			}
        // ------------ START EDITING HERE ----------------------
    ...
    void test02_MoreClosureIntro() {
        ...
        def monkeyColors = []
        // http://groovy.codehaus.org/groovy-jdk/java/lang/String.html#eachMatch(java.lang.String, groovy.lang.Closure)
        "I have seen blue monkeys, red monkeys, and purple monkeys".eachMatch('(\\w+) monkeys') { rta, coclor ->
            monkeyColors.add(coclor)
        }
		...
		file.eachLine {line-> line.startsWith("#")?: filteredResult.append(line+"\n")
